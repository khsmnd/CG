...
GLfloat MercDiffuse[] = { 0.7, 0.2, 0.73, 1.0f };			// Mercurio
GLfloat MercSpecular[] = { 0.8, 0.8, 0.8, 1.0 };
GLfloat MercShininess[] = { 50.0 };

GLfloat VenDiffuse[] = { 0.0f, 1.0f, 0.2f, 1.0f };		//Venus
...
GLfloat JupDiffuse[] = { 0.8f, 1.0f, 0.3f, 1.0f };			// Jupiter
GLfloat JupSpecular[] = { 1.0, 0.5, 0.0, 1.0 };
GLfloat JupShininess[] = { 50.0 };

GLfloat SatDiffuse[] = { 0.44f, 0.6f, 0.6f, 1.0f };			// Planeta saturno
GLfloat SatSpecular[] = { 1.0, 0.5, 0.0, 1.0 };
GLfloat SatShininess[] = { 50.0 };

GLfloat UrDiffuse[] = { 1.0f, 0.26f, 1.0f, 1.0f };			// Planeta saturno
GLfloat UrSpecular[] = { 1.0, 0.5, 0.0, 1.0 };
GLfloat UrShininess[] = { 50.0 };

GLfloat NepDiffuse[] = { 0.0f, 1.0f, 0.87f, 1.0f };			// Planeta saturno
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	glLightfv(GL_LIGHT1, GL_DIFFUSE, SunDiffuse); //se configura la fuente de luz (luz, tipo de luz, colores disponibles)
	glLightfv(GL_LIGHT1, GL_SPECULAR, SunSpecular); // lo mismo con la especular 
